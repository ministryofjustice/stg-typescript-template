...
const tasks: Array<Task> = [
  ...
  { code: 'test', description: 'Test deployment in the github workflow / actions ui' },
  {
    code: 'protect',
    description: 'Protect your default branch with a sensible github ruleset, see docs folder for more info',
  },
